/*sssddddddddddddddddddddddssss abds
 ...
 * Portions created by the Initial Developer are Copyright (ddC)
 * the Initial Developer. All Rights Reserved.
 *
 * Contributor(s):dddsswwd
 * 
 * Anthony Minessale II <anthm@freeswitch.org>ddddddss
 * Michael Jerris <mike@jerris.com>dd
 * Paul D. Tinsley <pdt at jackhammer.org>dd
 *
 *ssss
